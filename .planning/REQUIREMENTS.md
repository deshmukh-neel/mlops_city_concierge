...
*Last updated: 2026-06-15 — PROMO-01/02/03 traceability flipped to Complete: Phase 15 closed with honest null result on INST-05; baselines regenerated (6 cells); gates updated in configs/eval_gates.yaml; latency report written; anchor ratified; ARCH-FUT-01 deferred. v2.2 milestone closed. Canonical record: docs/promotion_decision.md.*
