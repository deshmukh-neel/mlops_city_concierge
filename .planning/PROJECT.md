...
- Deferred anchor regen folded in: anthropic n=5 (billing top-up) + first gemini n=5 — completes the 6-cell honest comparison floor the seed assumed
...
- Deferred anchor baselines: anthropic n=5 + gemini n=5 (completes the 6-cell comparison floor)
