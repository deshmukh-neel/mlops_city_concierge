...
| W8  | Live Google Map + multimodal itinerary routing (Tiered Directions re-timing) | [w8_live_map_routing.md](w8_live_map_routing.md) | `feature/agent-w8{a,b,c}-*` | W2, W3 | 🚧 w8a + w8b built (tests green; w8b pending real-API visual verification), w8c not started; streaming deferred |
