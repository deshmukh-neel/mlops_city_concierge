...
| W8  | Live Google Map + multimodal itinerary routing (Tiered Directions re-timing) | [w8_live_map_routing.md](w8_live_map_routing.md) | `feature/agent-w8{a,b,c}-*` | W2, W3 | 🚧 w8a ✅ merged (PR #86); w8b ✅ real-API verified 2026-05-17 (11/11 gate, 2 prod bugs found+fixed), PR pending; w8c not started; streaming deferred |
